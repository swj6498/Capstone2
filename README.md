...
| 분야 | 기술 |
|------|-------|
| **Frontend** | <img src="https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white"> <img src="https://img.shields.io/badge/Dart-0175C2?style=flat-square&logo=dart&logoColor=white"> |
| **Backend** | <img src="https://img.shields.io/badge/Firebase%20Functions-FFA611?style=flat-square&logo=firebase&logoColor=white"> <img src="https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=nodedotjs&logoColor=white"> |
| **Database** | <img src="https://img.shields.io/badge/Cloud%20Firestore-FFA611?style=flat-square&logo=firebase&logoColor=white"> |
...
### ✨ 주요 특징
  ...
  - 🔍 **Firestore 조건 쿼리 검색 + 해시태그**
    → 고급 필터링 및 해시태그 기반 게시물 검색​

  - 💬 **실시간 채팅방 (Firestore 동기화)**
    → 채팅방 생성/참가자 구조 + 메시지 실시간 동기화​

  - 👤 **Firebase Auth + 인증코드 검증**
    → 회원가입 시 SMS/이메일 인증코드 발송 및 검증

  - 📍 **Google Maps API + Geocoding 연동**
    → 게시물 거리순 정렬 + 위치 기반 검색

  - 🤖 **Google Gemini 기반 채팅 비속어 필터링 기능**  
    → 사용자 채팅의 은어/비속어 필터링
